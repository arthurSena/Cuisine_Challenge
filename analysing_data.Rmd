...
train.nnet<-nnet(target~.,train100,size=150,rang=0.07,Hess=FALSE,decay=0.001,maxit=250,MaxNWts = 55370)
...
trainData <- cbind(train_100_freq_ingred[, 1:348], class.ind(train_100_freq_ingred$target))
...
nn<-neuralnet(f,data=trainData,hidden=c(75,75),linear.output=F)
