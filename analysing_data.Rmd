...
Com esses dados em mãos, podemos gerar um dataset de treino que contenha apenas tais ingredientes (348) e, talvez assim,
diminuir a quantidade de variáveis usadas no nosso treinamento. A fim de gerar esse dataset, eu novamente utilizei
um script em python que se encarrega de gerar o CSV corretamente.
...
confusionMatrix(as.factor(test100$target),as.factor(round(res$net.result)))
```
